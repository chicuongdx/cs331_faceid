...
class ArcFaceModel:
    ...
    def recognize_face(self, image):
        ...
        for name in self.face_register.keys():
            ...
            for register_embedding in self.face_register[name]:
                match, cosine_similarity = self.match(embedding, register_embedding, name)
    ...
    def match(self, embedding1, embedding2, name):
        ...
        print('cosine similarity for {}: {}'.format(name, cosine_similarity))
